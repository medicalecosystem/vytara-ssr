...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-slate-900" style={{ backgroundColor: 'var(--theme-background)' }}>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        {/* HERO */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <span className="inline-block text-white px-4 py-1 rounded-full text-sm font-semibold mb-6" style={{ backgroundColor: 'var(--theme-navbar)' }}>
              Health Companion
            </span>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <button
                ...
                className={`px-10 py-5 text-lg rounded-2xl font-bold shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl ${
                  userId
                    ? "bg-[#734128]-500 hover:bg-emerald-600 text-white cursor-pointer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card
            ...
            bgColor={currentTheme === 'coffee' ? '#C7A07A' : 'var(--theme-card)'}
          />
          <Card
            title="Care Circle"
            icon={Users}
            onClick={() => setActiveSection("carecircle")}
            bgColor={currentTheme === 'coffee' ? '#C7A07A' : 'var(--theme-card)'}
          />
          <Card
            title="Vault"
...
function Card({ title, icon: Icon, onClick, bgColor }: any) {
  return (
    <div
      onClick={onClick}
      className="rounded-3xl p-6 shadow-lg hover:shadow-xl hover:scale-105 transition cursor-pointer border"
      style={{ backgroundColor: bgColor || 'var(--theme-card)', borderColor: 'var(--theme-border)' }}
    >
      <div className="w-14 h-14 mx-auto mb-4 rounded-full flex items-center justify-center symbol-bg" style={{ backgroundColor: 'var(--theme-primary)' }}>
        <Icon size={24} className="text-white" />
      </div>
      <h3 className="font-bold text-center" style={{ color: 'var(--theme-text)' }}>{title}</h3>
      <p className="text-xs text-center mt-2" style={{ color: 'var(--theme-text-secondary)' }}>View details</p>
    </div>
  );
}
