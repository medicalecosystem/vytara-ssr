      ...
      <main className="max-w-6xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <section className="space-y-6">
            <div className="rounded-3xl border border-white/20 shadow-xl shadow-teal-900/10 p-6 md:p-8" style={{ backgroundColor: 'var(--theme-card)', color: 'var(--theme-text)' }}>
              <div>
                <h2 className="text-2xl font-semibold">Family health records</h2>
                <p className="text-sm opacity-80">
            ...
            <div className="invites-card rounded-3xl border border-white/20 shadow-xl shadow-teal-900/10 p-6 md:p-8" style={{ backgroundColor: 'var(--theme-card)', color: 'var(--theme-text)' }}>
              <div>
                <h2 className="text-2xl font-semibold">Invites</h2>
                <p className="text-sm opacity-80">Manage pending invites in your family.</p>
              </div>
              <div className="mt-6 space-y-4">
                <div className={`rounded-2xl border border-slate-200 px-4 py-4 ${currentTheme === 'coffee' ? 'bg-[#E2CEB1]' : 'bg-white'}`}>
                  <button
                    type="button"
                    onClick={() => {
