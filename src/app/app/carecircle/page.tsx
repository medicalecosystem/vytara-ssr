    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--theme-background)' }}>
      <main className="max-w-6xl mx-auto px-6 py-10 space-y-6">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border text-white font-semibold shadow-sm transition" style={{ backgroundColor: 'var(--theme-secondary)' }}
              >
                Emergency card
              </button>
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-white font-semibold shadow-md shadow-teal-900/20 hover:opacity-90 transition"
                style={{
                  backgroundColor:
        ...
        {isEmergencyOpen && (
          ...
          >
          <section
            className={`w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/20 shadow-xl shadow-teal-900/10 p-6 md:p-8 space-y-6 ${currentTheme === 'coffee' ? 'bg-[#734128] text-white' : 'bg-white'}`} style={currentTheme !== 'coffee' ? { backgroundColor: 'var(--theme-card)' } : {}}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <section className="rounded-3xl border border-white/20 shadow-xl shadow-teal-900/10 p-6 md:p-8" style={{ backgroundColor: 'var(--theme-card)', color: 'var(--theme-text)' }}>
            <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className={`rounded-2xl border border-slate-200 px-4 py-4 ${currentTheme === 'coffee' ? 'bg-[#E2CEB1]' : 'bg-slate-50/70'}`}>
          ...
          <section className="rounded-3xl border border-white/20 shadow-xl shadow-teal-900/10 p-6 md:p-8" style={{ backgroundColor: 'var(--theme-card)', color: 'var(--theme-text)' }}>
            ...
            <div className="mt-6 space-y-4">
              <div className={`rounded-2xl border border-slate-200 px-4 py-4 ${currentTheme === 'coffee' ? 'bg-white' : 'bg-white'}`}>
                <button
                  type="button"
                  onClick={() => {
                    setShowIncomingPendingInvites(true);
